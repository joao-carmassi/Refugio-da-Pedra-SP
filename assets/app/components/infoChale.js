export default class {
    constructor(dados) {
        this.paiPc = document.getElementById("infoChale");
        this.paiCelular1 = document.querySelector(".infocelularInicio");
        this.paiCelular2 = document.querySelector(".infocelularFim");
        this.dados = dados;
        this.colocaHtmlDoom();
    }
    colocaHtmlDoom() {
        this.paiPc.innerHTML = this.htmlpC();
        this.paiCelular1.innerHTML = this.htmlCelular1();
        this.paiCelular2.innerHTML = this.htmlCelular2();
    }
    htmlCelular1() {
        return `
